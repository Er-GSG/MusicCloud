...
public final class deletecategory1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (rs.next()) {
        rs.deleteRow();
        response.sendRedirect("viewcategory.jsp?msg=Category Deleted");

    } else {
        response.sendRedirect("viewcategory.jsp?msg=Category Not Available");
    }
