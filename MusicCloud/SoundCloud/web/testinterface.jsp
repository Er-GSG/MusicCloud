    ...
    <head>
        ...
        <script>
            function go()
            {
                ...
                var h = document.g*etElementById("category").value;
    ...
    <center>
        <div >
            ...
            <form action="publicuserinterface2.jsp" method="post">
                <table>
                    <td> <select name="category" id="category" style="width: 500px;height: 20px;border-radius: 5px">
                            ...
                            %>
                        </select></td><td><input type="button" name="submit" value="Search" onclick="go()" style="width: 120px;height: 20px;border-radius: 5px;color: orangered;" /></td>
                    </tr>
                    <tr>
        ...
        <table width="50">
            <th><label style="color: white;font-family: sans-serif;font-size: 20px">Top Downloads</label></th> 
            <tr>  
                <%
                    int i = 0;
                    int Count;
