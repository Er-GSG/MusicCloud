...
<% 
 ...
 ResultSet rs = stmt.executeQuery("select * from user where username ='"+username+"' and password= '"+op+"'");
    ...
    
    {
        ...
        rs.updateRow();
        response.sendRedirect("userhome.jsp?msg= Password Changed Successfully");
    }
    ...
    
    {
        ...
        ("userchangepassword1.jsp?msg=invalid old password");
    }
