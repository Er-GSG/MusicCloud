 ...
 */
public class SendPlaylist extends HttpServlet {
    ...
    ResultSet rs7 = stmt7.executeQuery("select count(*)'count' from playlist where username= '"+username+"'");
    rs7.next();
    ...
    ResultSet rs = stmt.executeQuery("select * from playlist where username= '"+username+"'");
    while(rs.next())
    {
